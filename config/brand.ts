 ...
 * Generated for Joson Jewellery (Angamaly). Edit ONLY this file to rebrand.
 */
export const BRAND: BrandConfig = {
  businessName: "Joson Jewellery",
  tagline: "Timeless Gold, Diamond & Silver Jewellery in Angamaly",
  description:
    "Joson Jewellery is Angamaly's trusted destination for gold, diamond and silver jewellery. Rooted in the heart of Angamaly, we bring timeless craftsmanship to every celebration.",
  ...
  storyVideos: [
    ...
    {
      quote: "അങ്കമാലിയുടെ ഹൃദയത്തിൽ നിന്ന്.",
      description:
  ...
  address: "Aluva Road, near signal junction, Angamaly, Kerala 683572",
  city: "Angamaly",
  state: "Kerala",
  pincode: "683572",

  phone: "+919496564600",
  whatsapp: "919496564600",
  email: "",

  mapsLink:
    "https://share.google/4aTyco92n00bX6rmC",
  ...
  seo: {
    title: "Joson Jewellery | Jewellery in Angamaly",
    description:
      "Joson Jewellery - gold, diamond and silver jewellery in Angamaly, Kerala. Timeless craftsmanship for every celebration.",
    keywords: [
      "Joson Jewellery",
      "jewellery Angamaly",
      "gold jewellery Angamaly",
      "diamond jewellery Angamaly",
      "silver jewellery Angamaly",
      "jewellery store Ernakulam",
      "jewellery Kerala",
    ],
    canonical: "https://joson-jewellery-angamaly.vercel.app",
    ogImage:
      "https://joson-jewellery-angamaly.vercel.app/images/store1.webp",
  },

  faq: [],

  whatsappMessage:
    "Hello Joson Jewellery, I'd like to know more about your jewellery collections.",
};
